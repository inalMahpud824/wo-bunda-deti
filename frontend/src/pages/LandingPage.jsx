      ...
      <div className="w-full px-7 py-7 bg-[#fef9f5] text-black md:px-24">
        <div className="flex lg:flex-row flex-col justify-between md:gap-12 items-center min-h-[100px]">
          <div className="flex flex-col justify-center items-center rounded-xl shadow-lg bg-white p-7">
            <h2 className="text-2xl">Bunda deti</h2>
            <h3 className="text-2xl head-font text-center pb-2">Sekarang saatnya anda tidak perlu repot lagi mempersiapkan pernikahan, Anda dapat menikah dengan biaya yang terjangkau</h3>
        ...
        <div className="py-7">
          ...
          <div className="w-full flex justify-center items-center pt-8 pb-4">
            <Link to={"/service"} className="btn btn-secondary text-white rounded-2xl text-xl">Lihat Selengkapnya</Link>
          </div>
          <section className="py-10 bg-[#fdf7f2]">
            <h2 className="text-3xl text-center font-bold mb-6 head-font">Galeri Pernikahan</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-7">
              <img src="https://placehold.co/400" className="rounded-xl shadow-md object-cover" />
              <img src="https://placehold.co/400" className="rounded-xl shadow-md object-cover" />
              <img src="https://placehold.co/400" className="rounded-xl shadow-md object-cover" />
            </div>
          </section>
          <div className="w-full flex justify-center items-center pt-8 pb-4">
            <button className="btn btn-secondary text-white rounded-2xl text-xl">Lihat Selengkapnya</button>
          </div>
          <section className="py-12 bg-accent text-center text-secondary rounded-2xl shadow-sm">
            <h2 className="text-3xl font-bold">Siap Mewujudkan Pernikahan Impianmu?</h2>
            <p className="text-lg mt-2">Hubungi kami sekarang untuk konsultasi gratis!</p>
            <button className="btn btn-secondary mt-5 text-white">Hubungi Kami</button>
          </section>
        </div>
      </div>
      <Footer />
